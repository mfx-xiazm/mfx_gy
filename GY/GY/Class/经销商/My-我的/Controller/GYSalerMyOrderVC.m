...
@interface GYSalerMyOrderVC ()<JXCategoryViewDelegate,UIScrollViewDelegate,UITextFieldDelegate>
...
@implementation GYSalerMyOrderVC
...
-(void)setUpCategoryView
{
    ...
    _categoryView.titles = @[@"全部", @"待发货", @"待收货", @"待评价", @"已完成"];
